          ...
          {list.map(item => (
            <div key={item.id} class="history-item">
              <div class="history-item-names">
                <span class="history-original">{item.name}</span>
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" class="history-arrow">
                  <path d="M2 7h10M8 3l4 4-4 4" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <span class="history-new">{item.newName}</span>
              </div>
